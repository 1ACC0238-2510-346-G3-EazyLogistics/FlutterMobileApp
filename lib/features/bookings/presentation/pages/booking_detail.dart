                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Check-in
                        _buildDetailRow('Check-in', dateFormat.format(booking.checkInDate)),
                        const SizedBox(height: 12),
                        
                        // Check-out
                        _buildDetailRow('Check-out', dateFormat.format(booking.checkOutDate)),
                        const SizedBox(height: 12),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildPriceRow(
                          ...
                          currencyFormat.format(booking.pricePerNight * booking.nights),
                        ),
                        const SizedBox(height: 12),
                        
                        // Taxes
                        _buildPriceRow('Taxes & Fees', currencyFormat.format(booking.taxes)),
